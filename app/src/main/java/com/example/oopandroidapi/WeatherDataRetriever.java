...
public class WeatherDataRetriever {
    ...
    private final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?lat=%s&lon=%s&appid=08f195c6752a90dfa67fd92e78c13e7f&units=metric";

    // http://api.openweathermap.org/geo/1.0/direct?q={city name},{state code},{country code}&appid={API key}
    private  final String GEOLOCATION_API_URL = "http://api.openweathermap.org/geo/1.0/direct?q=%s&appid=08f195c6752a90dfa67fd92e78c13e7f&units=metric";
    ...
    public WeatherData getData(String municipalityName) {
        ...
        WeatherData weatherData = new WeatherData(
                ...
                weatherJson.get("coord").get("lat").asText(),
                weatherJson.get("coord").get("lon").asText()
        );
